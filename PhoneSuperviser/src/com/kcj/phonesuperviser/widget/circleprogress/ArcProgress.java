package com.kcj.phonesuperviser.widget.circleprogress;

import com.kcj.phonesuperviser.R;
import com.kcj.phonesuperviser.util.PixelUtil;
...
public class ArcProgress extends View{
	...
	public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		default_text_size = PixelUtil.sp2px( 18);
		min_size = (int) PixelUtil.dp2px(100);
		default_text_size = PixelUtil.sp2px( 40);
		default_suffix_text_size = PixelUtil.sp2px( 15);
		default_suffix_padding = PixelUtil.dp2px( 4);
		default_suffix_text = "%";
		default_bottom_text_size = PixelUtil.sp2px( 10);
		default_stroke_width = PixelUtil.dp2px( 4);
